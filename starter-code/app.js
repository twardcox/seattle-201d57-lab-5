...
function sumArray(sumArr) {
  ...
  //
  // 2,3,4 was passed in as an array of numbers, and 9 is their sum.
  return [summed, sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + summed + ' is their sum.'];
}
...
function multiplyArray(multArr) {
  ...
  for (var j = 0; j < multArr.length; j++) {
    multiples = multiply(multiples, multArr[j])[0];
    // console.log('multiples: ', multiples);
  }
  return [multiples, 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + multiples + '.'];
}
